...
import { View, Text, ScrollView, TouchableOpacity, TextInput, StyleSheet, Image, ToastAndroid, Modal, Alert, Platform, PermissionsAndroid, ActivityIndicator } from 'react-native';
    ...
    const capture = async (rdServicePackage) => {
        ...
        openFingerPrintScanner(rdServicePackage, pidOptions)
            ...
            .catch(async (error) => {
                ...
                Alert.alert('Connection Error', 'Please check if the device is connected and RD service is running.');
            });
    };
                ...
                <View style={styles.container}>
                    <View style={styles.body}>
                        ...
                        >
                            <FlotingInput
                                editable={false}
                                label={bankName ? bankName.toString() : "Select Your Bank"}
