...
import { View, Text, ScrollView, TouchableOpacity, TextInput, StyleSheet, Image, ToastAndroid, Modal, Alert, Platform, PermissionsAndroid, Linking, ActivityIndicator } from 'react-native';
