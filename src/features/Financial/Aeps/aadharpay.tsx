...
import { View, Text, ScrollView, TouchableOpacity, TextInput, StyleSheet, Image, ToastAndroid, Modal, Alert, PermissionsAndroid, } from 'react-native';
                ...
                <View style={styles.modalBackground}>
                    <View style={styles.modalContainer}>
                        <View style={styles.modalHeader}>
                            <Text style={styles.modalTitle}>{translate("Aadhar_Pay_Receipt")}</Text>
                        </View>
                        ...
                        <View style={styles.modalFooter}>
                            ...
                            >
                                <Text style={styles.footerButtonText}>{translate("Share_Receipt")}</Text>
                            </TouchableOpacity>
                            <TouchableOpacity
                                style={styles.footerButton}
                                onPress={onClose}
                            >
                                <Text style={styles.footerButtonText}>{translate("Close")}</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
